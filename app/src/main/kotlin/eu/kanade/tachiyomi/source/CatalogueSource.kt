...
interface CatalogueSource : Source {
     ...
     * Moved up to [Source] in tachiyomix 1.6; kept as an abstract member here so older extensions
     * overriding it on the catalogue interface still satisfy the contract.
     */
