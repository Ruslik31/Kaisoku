...
/**
 * [NsfwSourceOverrides] is the synchronous cache [MangaSource.isNsfw] consults before falling
 * back to [MangaSource.intrinsicIsNsfw]. These tests pin the override precedence rules.
 */
